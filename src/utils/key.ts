  ...
  return [
    {
      ...
      keycodes: [
        ...
        {name: '主页', code: 'KC_HOME', keys: 'home'},
        ...
        {name: '菜单', code: 'KC_APP', width: 1250, shortName: 'RApp'},
    ...
    },
    {
      ...
      width: 'label',
      keycodes: [
        {name: '音量减', code: 'KC_VOLD', title: 'Volume Down'},
        {name: '音量加', code: 'KC_VOLU', title: 'Volume Up'},
        {name: '静音', code: 'KC_MUTE', title: 'Mute Audio'},
        {name: '播放', code: 'KC_MPLY', title: 'Play/Pause'},
        {name: '停止', code: 'KC_MSTP', title: 'Media Stop'},
        {name: '上一曲', code: 'KC_MPRV', title: 'Media Previous'},
        {name: '下一曲', code: 'KC_MNXT', title: 'Media Next'},
        {name: '快退', code: 'KC_MRWD', title: 'Rewind'},
        {name: '快进', code: 'KC_MFFD', title: 'Fast Forward'},
        {name: '选择', code: 'KC_MSEL', title: 'Media Select'},
        {name: '弹出', code: 'KC_EJCT', title: 'Media Eject'},
      ],
    },
    {
      id: 'macro',
    ...
    buildLayerMenu(),
    {
      ...
      keycodes: [
        ...
        {name: '重置', code: 'RESET', title: 'Reset the keyboard'},
        {name: '调试', code: 'DEBUG', title: 'Toggle debug mode'},
        {
          name: '切换 NKRO',
        ...
        {name: '锁定数字锁定', code: 'KC_LNUM'},
        {name: '锁定大写锁定', code: 'KC_LCAP'},
        {name: '锁定滚动锁定', code: 'KC_LSCR'},
        {name: '电源', code: 'KC_PWR'},
        {name: 'Power OSX', code: 'KC_POWER'},
        {name: '睡眠', code: 'KC_SLEP'},
        {name: '唤醒', code: 'KC_WAKE'},
        {name: '计算器', code: 'KC_CALC'},
        {name: '邮件', code: 'KC_MAIL'},
        {name: '帮助', code: 'KC_HELP'},
        {name: '停止', code: 'KC_STOP'},
        {name: 'Alt Erase', code: 'KC_ERAS'},
        {name: '重做', code: 'KC_AGAIN'},
        {name: '菜单', code: 'KC_MENU'},
        {name: '撤销', code: 'KC_UNDO'},
        {name: '选择', code: 'KC_SELECT'},
        {name: '执行', code: 'KC_EXECUTE'},
        {name: '剪切', code: 'KC_CUT'},
        {name: '复制', code: 'KC_COPY'},
        {name: '粘贴', code: 'KC_PASTE'},
        {name: '查找', code: 'KC_FIND'},
        {name: '我的电脑', code: 'KC_MYCM'},
        {name: '主页', code: 'KC_WWW_HOME'},
        {name: '后退', code: 'KC_WWW_BACK'},
        {name: '前进', code: 'KC_WWW_FORWARD'},
        {name: '停止', code: 'KC_WWW_STOP'},
        {name: 'Refresh', code: 'KC_WWW_REFRESH'},
        {name: '收藏夹', code: 'KC_WWW_FAVORITES'},
    ...
    /* These are for controlling the original backlighting and bottom RGB. */
    {
      ...
      keycodes: [
        ...
        {name: '背光开启', code: 'BL_ON'},
        {name: '背光关闭', code: 'BL_OFF', shortName: 'BL Off'},
        {name: '背光亮度-', code: 'BL_DEC'},
        {name: '背光亮度+', code: 'BL_INC'},
        {name: '背光模式循环', code: 'BL_STEP'},
        {name: 'BR Toggle', code: 'BL_BRTG'},
        {name: 'RGB 开关', code: 'RGB_TOG'},
        {name: 'RGB 模式-', code: 'RGB_RMOD'},
        {name: 'RGB 模式+', code: 'RGB_MOD'},
        {name: '色相-', code: 'RGB_HUD'},
        {name: '色相+', code: 'RGB_HUI'},
        {name: '饱和度-', code: 'RGB_SAD'},
        {name: '饱和度+', code: 'RGB_SAI'},
        {name: '亮度-', code: 'RGB_VAD'},
        {name: '亮度+', code: 'RGB_VAI'},
        {name: '特效速度-', code: 'RGB_SPD'},
        {name: '特效速度+', code: 'RGB_SPI'},
        {name: 'RGB 模式P', code: 'RGB_M_P', title: 'Plain'},
        {name: 'RGB 模式B', code: 'RGB_M_B', title: 'Breathe'},
        {name: 'RGB 模式R', code: 'RGB_M_R', title: 'Rainbow'},
        {name: 'RGB 模式SW', code: 'RGB_M_SW', title: 'Swirl'},
        {name: 'RGB 模式SN', code: 'RGB_M_SN', title: 'Snake'},
        {name: 'RGB 模式K', code: 'RGB_M_K', title: 'Knight'},
        {name: 'RGB 模式X', code: 'RGB_M_X', title: 'Xmas'},
        {name: 'RGB 模式G', code: 'RGB_M_G', title: 'Gradient'},
      ],
    },
    /*
