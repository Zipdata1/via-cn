...
const BooleanControls: [LightingValue, string][] = [
  [LightingValue.BACKLIGHT_USE_7U_SPACEBAR, '使用 7U 空格键灯'],
  [LightingValue.BACKLIGHT_USE_ISO_ENTER, '使用 ISO 回车灯'],
  [LightingValue.BACKLIGHT_USE_SPLIT_BACKSPACE, '使用分裂退格灯'],
  [LightingValue.BACKLIGHT_USE_SPLIT_LEFT_SHIFT, '使用分裂左 Shift 灯'],
  [LightingValue.BACKLIGHT_USE_SPLIT_RIGHT_SHIFT, '使用分裂右 Shift 灯'],
  [
    LightingValue.BACKLIGHT_DISABLE_HHKB_BLOCKER_LEDS,
    '禁用 HHKB 挡块灯',
  ],
