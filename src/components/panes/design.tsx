    ...
    >
      ...
      <Grid style={{overflow: 'hidden'}}>
          ...
          <MenuContainer>
            <Row $selected={true}>
              <IconContainer>
                ...
                <MenuTooltip>{t('design.addDefinition')}</MenuTooltip>
              </IconContainer>
            </Row>
          </MenuContainer>
        </MenuCell>
        <SpanOverflowCell>
          <Container>
            <ControlRow>
              <Label>{t('design.loadDraftDefinition')}</Label>
              <Detail>
                <AccentUploadButton
                  multiple
            ...
            <ControlRow>
              <Label>{t('design.useV2Deprecated')}</Label>
              <Detail>
                <AccentSlider
            ...
            {definition && (
              <>
                <ControlRow>
                  <Label>{t('design.shownKeyboardDefinition')}</Label>
                  <Detail>
                    <AccentSelect
                      onChange={(option: any) => {
            ...
            {definition && (
              <ControlRow>
                <Label>{t('design.showMatrix')}</Label>
                <Detail>
                  <AccentSlider
            ...
            <ControlRow>
              <Label>{t('design.draftDefinitions')}</Label>
              <Detail>
                {Object.values(versionDefinitions).length} {t('design.definitions')}
              </Detail>
            </ControlRow>
