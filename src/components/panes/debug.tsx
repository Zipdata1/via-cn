...
import { useTranslation } from 'react-i18next'; //  һ
...
const TestControls = () => {
    ...
    return (
        <ControlGroup>
            <ControlGroupHeader>控件示例</ControlGroupHeader>
            <ControlRow>
                <Label>按钮</Label>
                <Detail>
                    <AccentButton>点击</AccentButton>
                </Detail>
            </ControlRow>
            <ControlRow>
                ...
                <Container>
                    ...
                    {api && (
                        <ControlGroup>
                            ...
                            <ControlRow>
                                <Label>{t('debug.eepromReset')}</Label>
                                <Detail>
                            ...
                            <ControlRow>
                                <Label>{t('debug.bootloaderJump')}</Label>
                                <Detail>
                    ...
                    <ControlGroup>
                        <ControlGroupHeader>设备标识</ControlGroupHeader>
                        <ControlRow>
