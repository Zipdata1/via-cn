        ...
        <>
            <IconButtonGroupContainer style={{ margin: '10px 15px' }}>
                <IconButtonContainer onClick={clear} disabled={!hasErrors}>
                    <FontAwesomeIcon size={'sm'} color="var(--color_label)" icon={faCancel} />
                    <IconButtonTooltip>Clear</IconButtonTooltip>
                </IconButtonContainer>
                <IconButtonContainer onClick={save} disabled={!hasErrors}>
                    <FontAwesomeIcon size={'sm'} color="var(--color_label)" icon={faDownload} />
                    <IconButtonTooltip>{t('common.download')}</IconButtonTooltip>
                </IconButtonContainer>
