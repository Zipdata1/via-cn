...
export const Test: FC = () => {
    ...
    const waveformOptions = [
        { label: t('test.waveformOption.sine'), value: 'sine' },
        { label: t('test.waveformOption.triangle'), value: 'triangle' },
        { label: t('test.waveformOption.sawtooth'), value: 'sawtooth' },
        { label: t('test.waveformOption.square'), value: 'square' },
    ];
    ...
    const modeOptions = [
        { label: t('test.modeOption.wickiHayden'), value: TestKeyboardSoundsMode.WickiHayden },
        { label: t('test.modeOption.chromatic'), value: TestKeyboardSoundsMode.Chromatic },
        { label: t('test.modeOption.random'), value: TestKeyboardSoundsMode.Random },
    ];
        ...
        <TestPane>
            <Grid>
                    ...
                    <MenuContainer>
                        <Row $selected={true}>
                            <IconContainer>
                                ...
                                <MenuTooltip>{t('test.checkKey')}</MenuTooltip>
                            </IconContainer>
                        </Row>
                    </MenuContainer>
                </MenuCell>
                <SpanOverflowCell>
                    <Container>
                        <ControlRow>
                            <Label>{t('test.resetKeyboard')}</Label>
                            <Detail>
                        ...
                        <ControlRow>
                            <Label>{t('test.keySounds')}</Label>
                            <Detail>
                                <AccentSlider
                                    isChecked={testKeyboardSoundsSettings.isEnabled}
                                    onChange={(val) => {
                                        dispatch(
                                            setTestKeyboardSoundsSettings({ isEnabled: val }),
                                        );
                                    }}
                                />
                            </Detail>
                            ...
                            <Detail>
                                <AccentRange
                                    ...
                                    onChange={(value: number) => {
                                        dispatch(setTestKeyboardSoundsSettings({ volume: value }));
                                    }}
                                />
                            </Detail>
                        </ControlRow>
                        <ControlRow>
                            <Label>{t('test.transpose')}</Label>
                            <Detail>
                                <AccentRange
                                    max={24}
                                    min={-24}
                                    ...
                                    onChange={(value: number) => {
                                        dispatch(
                                            setTestKeyboardSoundsSettings({ transpose: value }),
                                        );
                                    }}
                                />
                            </Detail>
                            ...
                            <Detail>
                                <AccentSelect
                                    ...
                                    onChange={(option: any) => {
                                        option &&
                                            dispatch(
                                                setTestKeyboardSoundsSettings({ mode: option.value }),
                                            );
                                    }}
                                />
                            </Detail>
